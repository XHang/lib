...
function(a) {
    ...
    function() {
        ...
        return f.load = function(a, b, g, e) {
            a = a.split(",");
            var d = [],
            k = (e.config && e.config.uikit && e.config.uikit.base ? e.config.uikit.base: "").replace(/\/+$/g, "");
    ...
    var b = {},
    g = a.UIkit ? Object.create(a.UIkit) : void 0;
    if (b.version = "2.25.0", b.noConflict = function() {
        return g && (a.UIkit = g, f.UIkit = g, f.fn.uk = g.fn),
        b
    },
    b.prefix = function(a) {
        return a
    },
    b.$ = f, b.$doc = b.$(document), b.$win = b.$(window), b.$html = b.$("html"), b.support = {},
    b.support.transition = function() {
        var a;
        a: {
            var b = c.body || c.documentElement,
            d = {
    ...
    } (), b.support.touch = "ontouchstart" in document || a.DocumentTouch && document instanceof a.DocumentTouch || a.navigator.msPointerEnabled && 0 < a.navigator.msMaxTouchPoints || a.navigator.pointerEnabled && 0 < a.navigator.maxTouchPoints || !1, b.support.mutationobserver = a.MutationObserver || a.WebKitMutationObserver || null, b.Utils = {},
    b.Utils.isFullscreen = function() {
        return document.webkitFullscreenElement || document.mozFullScreenElement || document.msFullscreenElement || document.fullscreenElement || !1
    },
    b.Utils.str2json = function(a, b) {
        try {
            return b ? JSON.parse(a.replace(/([\$\w]+)\s*:/g,
            function(a, b) {
                return '"' + b + '":'
            }).replace(/'([^']+)'/g,
            function(a, b) {
    ...
    b.Utils.removeCssRules = function(a) {
        ...
        a && setTimeout(function() {
            try {
                for (v = document.styleSheets, e = 0, f = v.length; f > e; e++) {
                    h = v[e];
                    d = [];
    ...
    b.Utils.isInView = function(a, d) {
        ...
        d),
        g + e.height() >= c && g - d.topoffset <= c + b.$win.height() && n + e.width() >= h && n - d.leftoffset <= h + b.$win.width() ? !0 : !1
    },
    b.Utils.checkDisplay = function(a, d) {
        ...
        return a && !e.length && (e = f(a)),
        e.trigger("display.uk.check"),
        d && ("string" != typeof d && (d = '[class*="uk-animation-"]'), e.find(d).each(function() {
            var a = b.$(this),
            k = a.attr("class").match(/uk\-animation\-(.+)/);
    ...
    b.Utils.options = function(a) {
        if ("string" != f.type(a)) return a; - 1 != a.indexOf(":") && "}" != a.trim().substr( - 1) && (a = "{" + a + "}");
        var d = a ? a.indexOf("{") : -1,
        e = {};
        if ( - 1 != d) try {
    ...
    b.Utils.animate = function(a, d) {
        var e = f.Deferred();
        return a = b.$(a),
        a.css("display", "none").addClass(d).one(b.support.animation.end,
        function() {
            a.removeClass(d);
            e.resolve()
        }),
    ...
    b.Utils.events = {},
    b.Utils.events.click = b.support.touch ? "tap": "click", a.UIkit = b, b.fn = function(a, d) {
        var e = arguments,
        h = a.match(/^([a-z\-]+)(?:\.([a-z]+))?/i),
        c = h[1],
        g = h[2];
    ...
    f.UIkit = b, f.fn.uk = b.fn, b.langdirection = "rtl" == b.$html.attr("dir") ? "right": "left", b.components = {},
    b.component = function(a, d) {
        var e = function(d, c) {
            var g = this;
            return this.UIkit = b,
            this.element = d ? b.$(d) : null,
            this.options = f.extend(!0, {},
            this.defaults, c),
            this.plugins = {},
            this.element && this.element.data(a, this),
            this.init(),
            (this.options.plugins.length ? this.options.plugins: Object.keys(e.plugins)).forEach(function(a) {
                e.plugins[a].init && (e.plugins[a].init(g), g.plugins[a] = !0)
            }),
            this.trigger("init.uk.component", [a, this]),
            this
        };
        return e.plugins = {},
        f.extend(!0, e.prototype, {
            defaults: {
                plugins: []
            },
            boot: function() {},
    ...
    b.on = function(a, d, e) {
        return a && -1 < a.indexOf("ready.uk.dom") && b.domready && d.apply(b.$doc),
        b.$doc.on(a, d, e)
    },
    ...
    b.domObserve = function(a, d) {
        b.support.mutationobserver && (d = d ||
        function() {},
        b.$(a).each(function() {
            var a = this,
            k = b.$(a);
    ...
    function() {
        var a = function() {
            ...
            requestAnimationFrame(function() {
                ...
                return b.support.touch && b.$html.on("touchmove touchend MSPointerMove MSPointerUp pointermove pointerup", c),
                (k || e) && c(),
                c
            } ());
            b.trigger("domready.uk.dom");
            b.support.touch && navigator.userAgent.match(/(iPad|iPhone|iPod)/g) && b.$win.on("load orientationchange resize", b.Utils.debounce(function() {
                var a = function() {
                    return f(".uk-height-viewport").css("height", window.innerHeight),
                    a
                };
                return a()
            } (), 100));
        ...
        return ("complete" == document.readyState || "interactive" == document.readyState) && setTimeout(a),
        a
    ...
    if (!a.fn.swipeLeft) {
        ...
        a(function() {
            ...
            function(a) { (a = 1 < a.originalEvent.velocityX ? "Right": -1 > a.originalEvent.velocityX ? "Left": 1 < a.originalEvent.velocityY ? "Down": -1 > a.originalEvent.velocityY ? "Up": null) && void 0 !== h.el && (h.el.trigger("swipe"), h.el.trigger("swipe" + a))
            }).on("touchstart MSPointerDown pointerdown",
            function(b) { ("MSPointerDown" != b.type || g(b.originalEvent)) && (n = "MSPointerDown" == b.type || "pointerdown" == b.type ? b: b.originalEvent.touches[0], m = Date.now(), r = m - (h.last || m), h.el = a("tagName" in n.target ? n.target: n.target.parentNode), e && clearTimeout(e), h.x1 = n.pageX, h.y1 = n.pageY, 0 < r && 250 >= r && (h.isDoubleTap = !0), h.last = m, l = setTimeout(c, 750), !p || "MSPointerDown" != b.type && "pointerdown" != b.type && "touchstart" != b.type || p.addPointer(b.originalEvent.pointerId))
            }).on("touchmove MSPointerMove pointermove",
            function(a) {
                if ("MSPointerMove" != a.type || g(a.originalEvent)) n = "MSPointerMove" == a.type || "pointermove" == a.type ? a: a.originalEvent.touches[0],
                l && clearTimeout(l),
                l = null,
                h.x2 = n.pageX,
                h.y2 = n.pageY,
                t += Math.abs(h.x1 - h.x2),
                q += Math.abs(h.y1 - h.y2)
            }).on("touchend MSPointerUp pointerup",
            function(c) {
                if ("MSPointerUp" != c.type || g(c.originalEvent)) l && clearTimeout(l),
                l = null,
                h.x2 && 30 < Math.abs(h.x1 - h.x2) || h.y2 && 30 < Math.abs(h.y1 - h.y2) ? k = setTimeout(function() {
    ...
    a.component("stackMargin", {
        ...
        b = function(a) {
            if (a.is(":visible")) {
                ...
                d = a.data("width"),
                k = Math.floor(b / d * a.data("height"));
                a.css({
                    height: d > b ? k: a.data("height")
                })
            }
        };
    ...
    a.Utils.stackMargin = function(c, b) {
        ...
        var g = !1,
        e = c.filter(":visible:first"),
        d = e.length ? e.position().top + e.outerHeight() - 1 : !1; ! 1 !== d && 1 != c.length && c.each(function() {
            var k = a.$(this);
    ...
    a.Utils.matchHeights = function(c, b) {
        ...
        var g = function(b) {
            if (! (2 > b.length)) {
                ...
                b.each(function() {
                    ...
                    var b = a.$(this),
                    e = d - ("border-box" == b.css("box-sizing") ? 0 : b.outerHeight() - b.height());
        ...
        a.Utils.inlineSvg = function(b, g) {
            a.$(b || 'img[src$=".svg"]', g || document).each(function() {
                ...
                c[d].then(function(d) {
                    ...
                    b.attr("height") && (d.attr("height", b.attr("height")), b.attr("width") || d.removeAttr("width"));
                    b.replaceWith(d)
                })
            })
        };
    ...
    function f(c, b) {
        ...
        b.duration, b.transition).promise().done(b.complete)
    }
    a.component("smoothScroll", {
        boot: function() {
            a.$html.on("click.smooth-scroll.uikit", "[data-uk-smooth-scroll]",
            function() {
                var c = a.$(this);
                c.data("smoothScroll") || (a.smoothScroll(c, a.Utils.options(c.attr("data-uk-smooth-scroll"))), c.trigger("click"));
                return ! 1
            })
        },
        init: function() {
    ...
    a.component("scrollspy", {
        ...
        init: function() {
            var d, e = this,
            c = this.options.cls.split(/,/),
            h = function() {
                var b = e.options.target ? e.element.find(e.options.target) : e.element,
                h = 1 === b.length ? 1 : 0,
                g = 0;
                b.each(function() {
                    var b = a.$(this),
                    f = b.data("inviewstate"),
                    m = a.Utils.isInView(b, e.options),
                    v = b.data("ukScrollspyCls") || c[g].trim(); ! m || f || b.data("scrollspy-idle") || (d || (b.addClass(e.options.initcls), e.offset = b.offset(), d = !0, b.trigger("init.uk.scrollspy")), b.data("scrollspy-idle", setTimeout(function() {
                    ...
                    e.options.delay * h)), h++); ! m && f && e.options.repeat && (b.data("scrollspy-idle") && (clearTimeout(b.data("scrollspy-idle")), b.data("scrollspy-idle", !1)), b.removeClass("uk-scrollspy-inview").toggleClass(v), b.data("inviewstate", !1), b.trigger("outview.uk.scrollspy"));
                    g = c[g + 1] ? g + 1 : 0
                })
            };
            h();
    ...
    a.component("scrollspynav", {
        ...
        init: function() {
            var b, d = [],
            c = this.find("a[href^='#']").each(function() {
            ...
            t = function() {
                ...
                if (b.length) {
                    ...
                    d && (n.options.closest ? (c.blur().closest(r).removeClass(g), e = c.filter("a[href='#" + d.attr("id") + "']").closest(r).addClass(g)) : e = c.removeClass(g).filter("a[href='#" + d.attr("id") + "']").addClass(g), n.element.trigger("inview.uk.scrollspynav", [d, e]))
                }
            };
        ...
        toggle: function() {
            if (this.totoggle.length) {
                if (this.options.animation && a.support.animation) {
                    var c = this,
                    b = this.options.animation.split(",");
                    1 == b.length && (b[1] = b[0]);
                    b[0] = b[0].trim();
                    b[1] = b[1].trim();
    ...
    a.component("alert", {
        ...
        boot: function() {
            a.$html.on("click.alert.uikit", "[data-uk-alert]",
            function(f) {
                var c = a.$(this);
    ...
    a.component("buttonRadio", {
        ...
        boot: function() {
            a.$html.on("click.buttonradio.uikit", "[data-uk-button-radio]",
            function(f) {
                var c = a.$(this);
    ...
    a.component("buttonCheckbox", {
        ...
        boot: function() {
            a.$html.on("click.buttoncheckbox.uikit", "[data-uk-button-checkbox]",
            function(f) {
                var c = a.$(this);
    ...
    a.component("button", {
        defaults: {},
        boot: function() {
            a.$html.on("click.button.uikit", "[data-uk-button]",
            function() {
                var f = a.$(this);
    ...
    function f(b, d, e, c) {
        if (b = a.$(b), d = a.$(d), e = e || window.innerWidth, c = c || b.offset(), d.length) {
            var g = d.outerWidth(); (b.css("min-width", g), "right" == a.langdirection) ? (d = e - (d.offset().left + g), e -= b.offset().left + b.outerWidth(), b.css("margin-right", d - e)) : b.css("margin-left", d.offset().left - c.left)
        }
    }
    var c, b = !1,
    g = {
    ...
    a.component("dropdown", {
        ...
        boot: function() {
            ...
            a.$html.on(b + ".dropdown.uikit", "[data-uk-dropdown]",
            function(d) {
                var e = a.$(this);
        ...
        init: function() {
            ...
            "click" == this.options.mode || a.support.touch ? this.on("click.uk.dropdown",
            function(b) {
                var e = a.$(b.target);
                ...
                d.element.hasClass("uk-open") ? (!d.dropdown.find(b.target).length || e.is(".uk-dropdown-close") || e.parents(".uk-dropdown-close").length) && d.hide() : d.show()
            }) : this.on("mouseenter",
            function() {
            ...
            function(e) {
                var c = a.$(e.target);
                return d.remainIdle && clearTimeout(d.remainIdle),
                b && b == d ? ((!d.dropdown.find(e.target).length || c.is(".uk-dropdown-close") || c.parents(".uk-dropdown-close").length) && d.hide(), void 0) : ((c.is("a[href='#']") || c.parent().is("a[href='#']")) && e.preventDefault(), d.show(), void 0)
            })
        },
        show: function() {
        ...
        registerOuterClick: function() {
            ...
            a.$html.off("click.outer.dropdown");
            setTimeout(function() {
                a.$html.on("click.outer.dropdown",
                function(e) {
                    c && clearTimeout(c);
                    a.$(e.target);
        ...
        checkDimensions: function() {
            if (this.dropdown.length) {
                ...
                n = (this.boundary[0] !== window && this.boundary.offset() ? this.boundary.offset() : {
                    top: 0,
                    left: 0
                },
                this.options.pos),
                ...
                q = {};
                if (b = n.split("-"), q = t[n] ? t[n] : t["bottom-left"], this.justified && this.justified.length) f(p.css({
                    left: 0
                }), this.justified, r);
                ...
                h > r && (p.addClass("uk-dropdown-stack"), this.trigger("stack.uk.dropdown", [this]));
                p.css(q).css("display", "").addClass("uk-dropdown-" + b[0])
            }
        },
        checkBoundary: function(b, d, e, c, g) {
            var f = "";
            return (0 > b || b - a.$win.scrollLeft() + e > g) && (f += "x"),
            (0 > d - a.$win.scrollTop() || d - a.$win.scrollTop() + c > window.innerHeight) && (f += "y"),
            f
        }
    });
        ...
        init: function() {
            ...
            this.on({
                ...
                "show.uk.dropdown": function() {
                    var b = d.dropdown.dropdown.outerHeight(!0);
                    d.dropdown.element.removeClass("uk-open");
                    d.overlay.stop().css("display", "block").animate({
                        height: b
                    },
                    d.options.duration,
                    function() {
    ...
    a.component("gridMatchHeight", {
        ...
        match: function() {
            ...
            if (c.length) return 100 <= Math.ceil(100 * parseFloat(c.css("width")) / parseFloat(c.parent().css("width"))) && !this.options.ignorestacked ? this.revert() : a.Utils.matchHeights(this.elements, this.options),
            this
        },
        revert: function() {
    ...
    a.component("modal", {
        ...
        show: function() {
            if (this.element.length) {
                var d = this;
                if (!this.isActive()) return this.options.modal && b && b.hide(!0),
                this.element.removeClass("uk-open").show(),
                this.resize(),
                this.options.modal && (b = this),
                this.active = !0,
                g++,
                a.support.transition ? (this.hasTransitioned = !1, this.element.one(a.support.transition.end,
                function() {
                    d.hasTransitioned = !0
                }).addClass("uk-open")) : this.element.addClass("uk-open"),
                e.addClass("uk-modal-page").height(),
                this.element.attr("aria-hidden", "false"),
                this.element.trigger("show.uk.modal"),
                a.Utils.checkDisplay(this.dialog, !0),
                this
            }
        },
        hide: function(b) {
            if (!b && a.support.transition && this.hasTransitioned) {
                var e = this;
                this.one(a.support.transition.end,
                function() {
                    e._hide()
                }).removeClass("uk-open")
            } else this._hide();
        ...
        resize: function() {
            ...
            if (this.scrollbarwidth = window.innerWidth - a, c.css(this.paddingdir, this.scrollbarwidth), this.element.css("overflow-y", this.scrollbarwidth ? "scroll": "auto"), !this.updateScrollable() && this.options.center) {
                var a = this.dialog.outerHeight(),
                b = parseInt(this.dialog.css("margin-top"), 10) + parseInt(this.dialog.css("margin-bottom"), 10);
                a + b < window.innerHeight ? this.dialog.css({
                    top: window.innerHeight / 2 - a / 2 - b
                }) : this.dialog.css({
                    top: ""
                })
            }
        ...
        updateScrollable: function() {
            ...
            if (a.length) {
                ...
                b = window.innerHeight - 2 * (20 > b ? 20 : b) - e;
                return a.css({
                    "max-height": b < this.options.minScrollHeight ? "": b,
                    height: ""
                }),
                !0
            }
    ...
    a.component("modalTrigger", {
        boot: function() {
            a.$html.on("click.modal.uikit", "[data-uk-modal]",
            function(b) {
                var e = a.$(this); (e.is("a") && b.preventDefault(), e.data("modalTrigger")) || a.modalTrigger(e, a.Utils.options(e.attr("data-uk-modal"))).show()
            });
    ...
    a.modal.alert = function(b, e) {
        ...
        e);
        var c = a.modal.dialog(['<div class="uk-margin uk-modal-content">' + String(b) + "</div>", '<div class="uk-modal-footer uk-text-right"><button class="uk-button uk-button-primary uk-modal-close">' + e.labels.Ok + "</button></div>"].join(""), e);
        return c.on("show.uk.modal",
        function() {
            setTimeout(function() {
    ...
    a.modal.confirm = function(b, e, c) {
        ...
        a.$.isFunction(g) ? {}: g),
        h = a.modal.dialog(['<div class="uk-margin uk-modal-content">' + String(b) + "</div>", '<div class="uk-modal-footer uk-text-right"><button class="uk-button js-modal-confirm-cancel">' + g.labels.Cancel + '</button> <button class="uk-button uk-button-primary js-modal-confirm">' + g.labels.Ok + "</button></div>"].join(""), g);
        return h.element.find(".js-modal-confirm, .js-modal-confirm-cancel").on("click",
        function() {
    ...
    a.modal.prompt = function(b, e, c, g) {
        ...
        g);
        var h = a.modal.dialog([b ? '<div class="uk-modal-content uk-form">' + String(b) + "</div>": "", '<div class="uk-margin-small-top uk-modal-content uk-form"><p><input type="text" class="uk-width-1-1"></p></div>', '<div class="uk-modal-footer uk-text-right"><button class="uk-button uk-modal-close">' + g.labels.Cancel + '</button> <button class="uk-button uk-button-primary js-modal-ok">' + g.labels.Ok + "</button></div>"].join(""), g),
        f = h.element.find("input[type='text']").val(e || "").on("keyup",
        function(a) {
            13 == a.keyCode && h.element.find(".js-modal-ok").trigger("click")
        });
        return h.element.find(".js-modal-ok").on("click",
        function() { ! 1 !== c(f.val()) && h.hide()
        }),
        h.on("show.uk.modal",
        function() {
            setTimeout(function() {
    ...
    a.modal.blockUI = function(b, e) {
        var c = a.modal.dialog("" + ('<div class="uk-margin uk-modal-content">' + String(b || '<div class="uk-text-center">...</div>') + "</div>"), a.$.extend({
            bgclose: !1,
            keyboard: !1,
            modal: !1
        },
        e));
        return c.content = c.element.find(".uk-modal-content:first"),
        c.show()
    };
    a.modal.labels = {
        Ok: "Ok",
    ...
    function f(c) {
        c = a.$(c);
        var b = "auto";
        if (c.is(":visible")) b = c.outerHeight();
        else {
            var g = {
    ...
    a.component("nav", {
        ...
        open: function(c, b) {
            ...
            k && (d.hasClass("uk-open") && k.removeClass("uk-hidden"), b ? (k.stop().height(d.hasClass("uk-open") ? "auto": 0), d.hasClass("uk-open") || k.addClass("uk-hidden"), this.trigger("display.uk.check")) : k.stop().animate({
                height: d.hasClass("uk-open") ? f(k.find("ul:first")) : 0
            },
            function() {
    ...
    c = window.scrollY,
    b = (a.$win, a.$doc, a.$html),
    g = {
        show: function(e) {
            if (e = a.$(e), e.length) {
                var d = a.$("body"),
                g = e.find(".uk-offcanvas-bar:first"),
                l = "right" == a.langdirection,
                p = (g.hasClass("uk-offcanvas-bar-flip") ? -1 : 1) * (l ? -1 : 1),
                h = window.innerWidth - d.width();
                ...
                d.css(l ? "margin-right": "margin-left", (l ? -1 : 1) * g.outerWidth() * p).width();
        ...
        hide: function(e) {
            var d = a.$("body"),
            g = a.$(".uk-offcanvas.uk-active"),
            l = "right" == a.langdirection,
            p = g.find(".uk-offcanvas-bar:first"),
            h = function() {
                d.removeClass("uk-offcanvas-page").css({
                    width: "",
                    height: "",
                    "margin-left": "",
                    "margin-right": ""
            ...
            g.length && (a.support.transition && !e ? (d.one(a.support.transition.end,
            function() {
                h()
        ...
        _initElement: function(b) {
            b.data("OffcanvasInit") || (b.on("click.uk.offcanvas swipeRight.uk.offcanvas swipeLeft.uk.offcanvas",
            function(b) {
                var e = a.$(b.target);
                if (b.type.match(/swipe/) || e.hasClass("uk-offcanvas-close") || !e.hasClass("uk-offcanvas-bar") && !e.parents(".uk-offcanvas-bar:first").length) b.stopImmediatePropagation(),
                g.hide()
            }), b.on("click", "a[href*='#']",
            function() {
                var b = a.$(this),
                e = b.attr("href");
                "#" != e && (a.$doc.one("hide.uk.offcanvas",
                function() {
                    var c;
                    try {
                        c = a.$(b[0].hash)
    ...
    function f(b, c, e) {
        ...
        return e[0] === c[0] ? (f.resolve(), f.promise()) : ("object" == typeof b && (l = b[0], p = b[1] || b[0]), a.$body.css("overflow-x", "hidden"), d = function() {
            ...
            e.addClass(l).one(a.support.animation.end,
            function() {
                e.removeClass("" + l).css({
                    opacity: "",
                    display: ""
        ...
        e.css("animation-duration", this.options.duration + "ms"), c && c.length ? (c.css("animation-duration", this.options.duration + "ms"), c.css("display", "none").addClass(p + " uk-animation-reverse").one(a.support.animation.end,
        function() {
            d()
    ...
    a.component("switcher", {
        ...
        init: function() {
            var b = this;
            if (this.on("click.uk.switcher", this.options.toggle,
            function(a) {
                a.preventDefault();
                b.show(this)
                ...
                this.connect.length && (this.connect.children().attr("aria-hidden", "true"), this.connect.on("click", "[data-uk-switcher-item]",
                function(d) {
                    d.preventDefault();
        ...
        show: function(b, g) {
            if (!this.animating) {
                ...
                var d = this,
                e = this.find(this.options.toggle),
                k = a.$(b),
                l = c[this.options.animation] ||
                function(a, b) {
                ...
                k.hasClass("uk-disabled") || (e.attr("aria-expanded", "false"), k.attr("aria-expanded", "true"), e.filter(".uk-active").removeClass("uk-active"), k.addClass("uk-active"), this.options.connect && this.connect.length && (this.index = this.find(this.options.toggle).index(k), -1 == this.index && (this.index = 0), this.connect.each(function() {
                    var b = a.$(this),
                    b = a.$(b.children()),
                    e = a.$(b.filter(".uk-active")),
                    c = a.$(b.eq(d.index));
                    d.animating = !0;
    ...
    c = {
        ...
        "slide-vertical": function(a, c) {
            ...
            return a && a.index() > c.index() && e.reverse(),
            f.apply(this, [e, a, c])
        },
    ...
    a.component("tab", {
        ...
        init: function() {
            ...
            function(c) { (c.preventDefault(), f.switcher && f.switcher.animating) || (c = f.find(f.options.target).not(this), c.removeClass("uk-active").blur(), f.trigger("change.uk.tab", [a.$(this).addClass("uk-active"), f.current]), f.current = a.$(this), f.options.connect || (c.attr("aria-expanded", "false"), a.$(this).attr("aria-expanded", "true")))
            });
        ...
        check: function() {
            ...
            if (!f.length) return this.responsivetab.addClass("uk-hidden"),
            void 0;
            var c, b, g = f.eq(0).offset().top + Math.ceil(f.eq(0).height() / 2),
            e = !1;
            if (this.responsivetab.lst.empty(), f.each(function() {
                a.$(this).offset().top > g && (e = !0)
            }), e) for (var d = 0; d < f.length; d++) c = a.$(f.eq(d)),
            c.find("a"),
            "none" == c.css("float") || c.attr("uk-dropdown") || (c.hasClass("uk-disabled") || (b = c[0].outerHTML.replace("<a ", '<a data-index="' + d + '" '), this.responsivetab.lst.append(b)), c.addClass("uk-hidden"));
...
function(a) {
    ...
    "function" == typeof define && define.amd && define("uikit-parallax", ["uikit"],
    function() {
        return f || a(UIkit)
    })
} (function(a) {
    function f(b, d, c) {
        ...
        e = g.css("background-image").replace(/^url\(/g, "").replace(/\)$/g, "").replace(/("|')/g, ""),
        k = function() {
            var a = g.innerWidth(),
            e = g.innerHeight(),
            k = "bg" == d ? c.diff: c.diff / 100 * e;
            return e += k,
            a += Math.ceil(k * l),
            a - k < f.w && e < f.h ? b.element.css({
                "background-size": "auto"
            }) : (e > a / l ? (v = Math.ceil(e * l), w = e, e > window.innerHeight && (v *= 1.2, w *= 1.2)) : (v = a, w = Math.ceil(a / l)), g.css({
                "background-size": v + "px " + w + "px"
            }).data("bgsize", {
                w: v,
                h: w
            }), void 0)
    ...
    function c(a) {
        var b;
        return (b = /#([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})/.exec(a)) ? [parseInt(b[1], 16), parseInt(b[2], 16), parseInt(b[3], 16), 1] : (b = /#([0-9a-fA-F])([0-9a-fA-F])([0-9a-fA-F])/.exec(a)) ? [17 * parseInt(b[1], 16), 17 * parseInt(b[2], 16), 17 * parseInt(b[3], 16), 1] : (b = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/.exec(a)) ? [parseInt(b[1]), parseInt(b[2]), parseInt(b[3]), 1] : (b = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9\.]*)\s*\)/.exec(a)) ? [parseInt(b[1], 10), parseInt(b[2], 10), parseInt(b[3], 10), parseFloat(b[4])] : l[a] || [255, 255, 255, 0]
    }
    var b = [],
    g = !1,
    e = 0,
    ...
    a.component("parallax", {
        ...
        boot: function() {
            g = function() {
                ...
                for (var c in d) void 0 !== b.style[c] && (b.style[c] = "translate3d(1px,1px,1px)", a = window.getComputedStyle(b).getPropertyValue(d[c]));
                return document.body.removeChild(b),
                void 0 !== a && 0 < a.length && "none" !== a
            } ();
        ...
        process: function() {
            ...
            var a = this.percentageInViewport(); ! 1 !== this.options.viewport && (a = 0 === this.options.viewport ? 1 : a / this.options.viewport);
            this.update(a)
        },
        percentageInViewport: function() {
            var a, b, c, g = this.base.offset().top,
            f = this.base.outerHeight();
            return g > e + d ? c = 0 : e > g + f ? c = 1 : d > g + f ? c = (d > e ? e: e - d) / (g + f) : (a = e + d - g, b = Math.round(a / ((d + f) / 100)), c = b / 100),
            c
        },
        update: function(a) {
            var b, d, e = {
            ...
            k = a * (1 - (this.velocity - this.velocity * a));
            0 > k && (k = 0);
            1 < k && (k = 1); (void 0 === this._percent || this._percent != k) && (Object.keys(this.props).forEach(function(l) {
                ...
                case "border-color":
                    ...
                    u = c(u),
                    v = v || 0,
                    v = "rgba(" + parseInt(q[0] + v * (u[0] - q[0]), 10) + "," + parseInt(q[1] + v * (u[1] - q[1]), 10) + "," + parseInt(q[2] + v * (u[2] - q[2]), 10) + "," + (q && u ? parseFloat(q[3] + v * (u[3] - q[3])) : 1) + ")";
                    e[l] = v;
                    break;
                default:
                    e[l] = d
...
function(a) {
    var f;
    window.UIkit && (f = a(UIkit));
    "function" == typeof define && define.amd && define("uikit-sticky", ["uikit"],
    function() {
        return f || a(UIkit)
    })
} (function(a) {
...
function(a) {
    ...
    return a.component("tooltip", {
        defaults: {
            ...
            src: function(a) {
                var b = a.attr("title");
                return void 0 !== b && a.data("cached-title", b).removeAttr("title"),
                a.data("cached-title")
            }
        },
        tip: "",
            ...
            if (this.tip = "function" == typeof this.options.src ? this.options.src(this.element) : this.options.src, c && clearTimeout(c), b && clearTimeout(b), "string" == typeof this.tip ? this.tip.length: 0) {
                ...
                c = setTimeout(function() {
                    ...
                    g.options.animation ? f.css({
                        opacity: 0,
                        display: "block"
                    }).addClass(g.options.activeClass).animate({
                        opacity: 1
                    },
                    parseInt(g.options.animation, 10) || 400) : f.show().addClass(g.options.activeClass);
                    c = !1;
        ...
        hide: function() {
            if (!this.element.is("input") || this.element[0] !== document.activeElement) if (c && clearTimeout(c), b && clearTimeout(b), f.stop(), this.options.animation) {
                var a = this;
                f.fadeOut(parseInt(this.options.animation, 10) || 400,
                function() {
        ...
        checkBoundary: function(b, e, d, c) {
            var f = "";
            return (0 > b || b - a.$win.scrollLeft() + d > window.innerWidth) && (f += "x"),
            (0 > e || e - a.$win.scrollTop() + c > window.innerHeight) && (f += "y"),
            f
        }
    }),
    a.tooltip
...
function(a) {
    var f;
    window.UIkit && (f = a(UIkit));
    "function" == typeof define && define.amd && define("uikit-notify", ["uikit"],
    function() {
        return f || a(UIkit)
    })
} (function(a) {
    ...
    b = function(b, d) {
        ...
        d && (b = a.$.extend(b, "string" == a.$.type(d) ? {
            status: d
        }: d)),
        (new g(b)).show()
    },
    g = function(b) {
        ...
        this.element = a.$('<div class="uk-notify-message"><a class="uk-close"></a><div></div></div>').data("notifyMessage", this);
        ...
        c[this.uuid] = this;
        f[this.options.pos] || (f[this.options.pos] = a.$('<div class="uk-notify uk-notify-' + this.options.pos + '"></div>').appendTo("body").on("click", ".uk-notify-message",
        function() {
    ...
    a.notify = b,
    a.notify.message = g,
    a.notify.closeAll = function(a, b) {
        var f;
        if (a) for (f in c) a === c[f].group && c[f].close(b);
        else for (f in c) c[f].close(b)
    },
    b
}); !
function(a) {
    ...
    return a.component("lightbox", {
        ...
        items: !1,
        boot: function() {
            a.$html.on("click", "[data-uk-lightbox]",
            function(b) {
                b.preventDefault();
                b = a.$(this);
        ...
        fitSize: function() {
            var b = this,
            c = this.data,
            d = this.modal.dialog.outerWidth() - this.modal.dialog.width(),
            f = parseInt(this.modal.dialog.css("margin-top"), 10),
            l = parseInt(this.modal.dialog.css("margin-bottom"), 10),
            l = f + l,
            p = c.meta.content,
            f = b.options.duration;
            ...
            function(a, c) {
                if ("image" == c.type || c.source && c.source.match(/\.(jpg|jpeg|png|gif|svg)$/i)) {
                    var f = function(a, b, e) {
                        c.meta = {
                            content: '<img class="uk-responsive-width" width="' + b + '" height="' + e + '" src ="' + a + '">',
                            width: b,
                            height: e
                        };
                        c.type = "image";
                    ...
                    if (b[c.source]) f(c.source, b[c.source].width, b[c.source].height);
                    else {
                        var g = new Image;
                        g.onerror = function() {
        ...
        init: function(a) {
            ...
            function(a, f) {
                ...
                if ((h = f.source.match(c)) && (g = h[2]), (h = f.source.match(d)) && (g = h[1]), g) {
                    if (b[g]) m(g, b[g].width, b[g].height);
                    else {
                        var r = new Image,
                        n = !1;
                        r.onerror = function() {
        ...
        init: function(c) {
            ...
            function(c, d) {
                var f = function(a, b, c) {
                    d.meta = {
                        content: '<video class="uk-responsive-width" src="' + a + '" width="' + b + '" height="' + c + '" controls></video>',
                        width: b,
                        height: c
                    };
                    d.type = "video";
                ...
                if ("video" == d.type || d.source.match(/\.(mp4|webm|ogv)$/i)) if (b[d.source]) f(d.source, b[d.source].width, b[d.source].height);
                else var g = a.$('<video style="position:fixed;visibility:hidden;top:-10000px;"></video>').attr("src", d.source).appendTo("body"),
                p = setInterval(function() {
                    g[0].videoWidth && (clearInterval(p), b[d.source] = {
                        width: g[0].videoWidth,
                        height: g[0].videoHeight
                    },
                    f(d.source, b[d.source].width, b[d.source].height), g.remove())
                },
                20)
            })
        }
...
function grin(a) {
    var f;
    a = " " + a + " ";
    if (document.getElementById("comment") && "textarea" == document.getElementById("comment").type) f = document.getElementById("comment");
    else return ! 1;
    if (document.selection) f.focus(),
    sel = document.selection.createRange(),
    sel.text = a,
    f.focus();
    else if (f.selectionStart || "0" == f.selectionStart) {
        var c = f.selectionEnd,
        b = c;
...
function fen_qzhai() {
    if ("0" == $(".favorite").attr("cl")) {
        for (var a = 100,
        f = 1; 8 > f; f++) $(".fen li:nth-child(" + f + ")").css("transform", "rotate(" + a + "deg)"),
        $(".fen li:nth-child(" + f + ")").children().children().css("transform", "rotate(-" + a + "deg)"),
        $(".fen li:nth-child(" + f + ")").children().animate({
            fontSize: "1.4rem"
        },
        100,
        function() {
        ...
        a = 100;
        for (f = 1; 8 > f; f++) $(".fen li:nth-child(" + f + ")").children().animate({},
        400,
        function() {
...
$(function() {
    $("#op_m").click(function() {
        "lock" != $("#op_hed").attr("lock") ? ($("#op_hed").attr("lock", "lock"), $("#op_hed").animate({
            ...
            width: "260px"
        }), $("#op_m").removeClass("uk-icon-music"), $("#op_m").addClass("uk-icon-close")) : "lock" == $("#op_hed").attr("lock") && ($("#op_hed").attr("lock", "open"), $("#op_hed").animate({
            right: "0px",
            left: "0px"
        }), $(".op").animate({
            width: "80%"
        }), $("#op_m").removeClass("uk-icon-close"), $("#op_m").addClass("uk-icon-music"))
    });
...
function archive() {
    ...
    $(".car-collapse").find(".car-toggler").click(function() {
        "\u5c55\u5f00\u6240\u6709\u6708\u4efd" == jQuery(this).text() ? ($(this).parent(".car-container").find(".car-monthlisting").show(), $(this).text("\u6298\u53e0\u6240\u6709\u6708\u4efd")) : ($(this).parent(".car-container").find(".car-monthlisting").hide(), $(this).text("\u5c55\u5f00\u6240\u6709\u6708\u4efd"));
        return ! 1
    })
}
function comments() {
    $("#submit").click(function() {
        ...
        if ("" == $("#comment").val()) return $("#comment").addClass("uk-form-danger"),
        $("#comment").attr("placeholder", "\u5185\u5bb9\u4e0d\u80fd\u4e3a\u7a7a"),
        UIkit.notify("<i class='uk-icon-remove'></i> \u5185\u5bb9\u4e0d\u80fd\u4e3a\u7a7a", {
            pos: "bottom-right",
            status: "danger"
        }),
        !1;
        if ("" == $("#author").val()) return $("#author").addClass("uk-form-danger"),
        $("#author").attr("placeholder", "\u6635\u79f0\u4e0d\u80fd\u4e3a\u7a7a"),
        UIkit.notify("<i class='uk-icon-remove'></i> \u6635\u79f0\u4e0d\u80fd\u4e3a\u7a7a", {
            pos: "bottom-right",
            status: "danger"
        }),
        !1;
        ...
        UIkit.notify("<i class='uk-icon-remove'></i> \u90ae\u7bb1\u4e0d\u80fd\u4e3a\u7a7a", {
            pos: "bottom-right",
            status: "danger"
        }),
        !1
...
ajaxsearch_class = "s",
ajaxloading_error_code = '<div id="index" class="bs" style="width:100%; height:80vh"><h4>\u52a0\u8f7d\u5931\u8d25</h4> <article id="article" class="uk-article"><p>\u52a0\u8f7d\u5931\u8d25 ...</p></article></div>',
ajaxreloadDocumentReady = !1,
ajaxtrack_analytics = !1,
ajaxscroll_top = !0,
ajaxisLoad = !1,
ajaxstarted = !1,
ajaxsearchPath = null,
ajaxua = jQuery.browser;
...
window.onpopstate = function(a) { ! 0 === ajaxstarted && 1 == ajaxcheck_ignore(document.location.toString()) && ajaxloadPage(document.location.toString(), 1)
};
